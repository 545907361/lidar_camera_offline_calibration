...
int RSLIDAR_RING::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __int16_t_encode_array(buf, offset + pos, maxlen - pos, &this->gfX[0], 2200);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int16_t_encode_array(buf, offset + pos, maxlen - pos, &this->gfY[0], 2200);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int16_t_encode_array(buf, offset + pos, maxlen - pos, &this->gfZ[0], 2200);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __byte_encode_array(buf, offset + pos, maxlen - pos, &this->gnI[0], 2200);
    if(tlen < 0) return tlen; else pos += tlen;
...
int RSLIDAR_RING::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __int16_t_decode_array(buf, offset + pos, maxlen - pos, &this->gfX[0], 2200);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int16_t_decode_array(buf, offset + pos, maxlen - pos, &this->gfY[0], 2200);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int16_t_decode_array(buf, offset + pos, maxlen - pos, &this->gfZ[0], 2200);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __byte_decode_array(buf, offset + pos, maxlen - pos, &this->gnI[0], 2200);
    if(tlen < 0) return tlen; else pos += tlen;
...
int RSLIDAR_RING::_getEncodedSizeNoHash() const
{
    ...
    enc_size += __int16_t_encoded_array_size(NULL, 2200);
    enc_size += __int16_t_encoded_array_size(NULL, 2200);
    enc_size += __int16_t_encoded_array_size(NULL, 2200);
    enc_size += __byte_encoded_array_size(NULL, 2200);
    return enc_size;
}

uint64_t RSLIDAR_RING::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x85cc40ed25068235LL;
